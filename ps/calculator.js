    ...
    renderSelectedCosts() {
        ...
        container.innerHTML = this.selectedCosts.map((item, index) => `
            <div class="cart-item">
                ...
                <button class="btn-secondary btn-icon-only danger" onclick="calculator.removeAdditionalCost(${index})" title="Remover">
    ...
    setupEventListeners() {
        ...
        if (btnSaveToCatalog) {
            btnSaveToCatalog.onclick = () => {
                ...
                location.href = '/ps/meucatalogo/additem/';
            };
        }
...
window.calculator = calculator;
>>>>>>> 5e21ac9a8408cf132a049eb2730d818cf0f8132f:printsystem/calculator.js
