<<<<<<< HEAD:ps/vendas/item/details.js
const vendasItem = {
    sale: null,
    ...
    setupEventListeners() {
        document.getElementById('btn-back').onclick = () => location.href = '/ps/vendas/';
    ...
    render() {
        ...
        // Datas Registradas
        const datesList = document.getElementById('detail-dates-list');
        ...
        const dates = [
            { label: 'Registrado', value: formatDate(sale.created_at) },
            { label: 'Agendamento', value: formatDate(sale.data_agendamento) },
            { label: 'Venda concluída', value: formatDate(sale.data_venda) },
            { label: 'Cancelamento', value: formatDate(sale.data_cancelamento) }
        ];
...
window.vendasItem = vendasItem;
>>>>>>> 5e21ac9a8408cf132a049eb2730d818cf0f8132f:printsystem/vendas/item/details.js
